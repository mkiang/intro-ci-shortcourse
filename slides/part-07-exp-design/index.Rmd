...
Because we randomized, we can use very simple tests to compare means. This is obviously very attractive because they are simple to set up and get running and so many large companies run hundreds of A/B tests every week. **NEXT SLIDE**
...
$$\begin{align*}
R &\enspace& X_{a1b1} &\enspace& O \\
R &\enspace& X_{a1b2} &\enspace& O \\
R &\enspace& X_{a2b1} &\enspace& O \\
R &\enspace& X_{a2b2} &\enspace& O 
\end{align*}$$
...
- Essential two RCTs with just a single experiment (half the sample size)
