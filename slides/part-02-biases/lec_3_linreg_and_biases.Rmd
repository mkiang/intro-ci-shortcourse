...
- 0/1 outcome variable?
  ...
  - Probit regression has a more economic interpretation, based on an individual's utility functions 
  - Poisson or negative-binomial regression for counts
- Truncated/Censored Observation (e.g., test scores, wage)
- Non-negative outcomes (Tobit regression, assumes a latent variable that can take negative values)
- Attrition bias
