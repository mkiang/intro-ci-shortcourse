...
Then, within this framework, what is the ideal situation. Like all frameworks, there are fundamental assumptions. So as a starting point, we'll go over situations when these assumptions are guaranteed to be met. A little bit about RCTs and why they're powerful. **NEXT SLIDE**
