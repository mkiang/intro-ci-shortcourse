...
--
.right-column[
- That coefficient from your difference-in-differences IPW model — not a causal effect.
]
--
.right-column[
- That estimate from your new cutting edge machine learning algorithm — not a causal effect.
]
--
.right-column[
...
--
.right-column[
- Important because it reduces the number of potential outcomes for ecah unit to two.
]
---
