...
--
.right-column[
If we knew this, we could just take $\bar\tau=\frac{1}{n}\sum(Y_{i1}-Y_{i0})$ to get the average treatment effect
]
---
layout: false
.left-column[
...
--
.right-column[
That is, we only observe one of the two potential outcomes.
]
--
.right-column[
Of course, this is impossible.
