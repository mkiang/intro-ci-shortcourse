...
We only observe one of the potential outcomes — thus, individual causal effects cannot be estimated
]
---
class: center, middle
...
--
.right-column[
If we had "God's Data", the average causal effect would be $$ATE=E[Y^{a=0}]-E[Y^{a=1}]$$
]
---
.right-column[
