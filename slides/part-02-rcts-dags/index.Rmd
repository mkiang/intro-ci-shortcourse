...
### Thinking about how bias affects the ideal case (more next lecture)

---
# Randomized Control Trials

- Recall from last lecture, because of Fundamental Problem of Causal Inference, we can never observe both counterfactuals.
