...
- Reverse causation (3) can really only be addressed through temporal ordering, but must be noted because things can often be both forward and reversely causal.

--

- So we are going to focus on the structural foundations of **confounding** and **collider bias**.
...
- Examples: Party at my house; fast and tall NBA players.
